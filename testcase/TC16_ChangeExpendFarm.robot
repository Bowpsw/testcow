...
*** Test Cases ***
TC16_ChangeExpendFarm
    # Start Video Recording    name=D:/robot_pjtest/results/TC16_ChangeExpendFarm/video/TC16_ChangeExpendFarm  fps=None    size_percentage=1   embed=True  embed_width=100px   monitor=1    
    Open Excel Document    D:/robot_pjtest/testdata/TC16_ChangeExpendFarm.xlsx    doc_id=TestData
    ...
    FOR    ${i}    IN RANGE    2    ${excel.max_row+1}
        ...
        LoginPage 
            ...
            Run Keyword If     '${Status}' == 'FAIL'    Capture Page Screenshot    D:/robot_pjtest/results/TC16_ChangeExpendFarm/Screenshot/${tcid}.png
    ...
    END                                                    
    Save Excel Document    D://robot_pjtest//results//TC16_ChangeExpendFarm//WriteExcel//TC16_ChangeExpendFarm_Result.xlsx
