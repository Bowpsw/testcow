...
${vbc_manu2}    xpath=//android.view.View[@content-desc="เข้าสู่ระบบ"]
${vbc_emp}    xpath=//android.widget.RadioButton[@index='2']
...
${alert_login}    xpath=//android.view.View[@index='8']
...
*** Test Cases ***
TC02_Login
    Start Video Recording    name=D:/robot_pjtest/results/TC02_Login/video/TC02_Login  fps=None    size_percentage=1   embed=True  embed_width=100px   monitor=1    
    Open Excel Document    D:/robot_pjtest/testdata/TC02_Login.xlsx    doc_id=TestData
    ...
    FOR    ${i}    IN RANGE    2    ${excel.max_row+1}
        ...
        IF    "${status_yn}" == "Y"
            ...
            Run Keyword If     '${Status}' == 'FAIL'    Capture Page Screenshot    D:/robot_pjtest/results/TC02_Login/Screenshot/${tcid}.png
    ...
    END                                                    
    Save Excel Document    D://robot_pjtest//results//TC02_Login//WriteExcel//TC02_Login_Result.xlsx
...
KeyInformation 
    ...
    Click Element    ${vb_us}  
    # Wait Until Page Contains Element  ${vb_us}   1s
