...
${vb_cprogress}    xpath=//android.view.View[@content-desc="พัฒนาการโค"]

${vb_Swipe}    xpath=//android.widget.ImageView[@index='0'][1]
${vb_Remove}    xpath=//android.widget.Button[@content-desc="ลบข้อมูลการพัฒนาโค"]
...
*** Test Cases ***
TC06_RemoveCowprogress
    Start Video Recording    name=D:/robot_pjtest/results/TC06_RemoveCowprogress/video/TC06_RemoveCowprogress  fps=None    size_percentage=1   embed=True  embed_width=100px   monitor=1    
    Open Excel Document    D:/robot_pjtest/testdata/TC06_RemoveCowprogress.xlsx    doc_id=TestData
    ...
    FOR    ${i}    IN RANGE    2    ${excel.max_row+1}
        ...
        LoginPage 
            ...
            Run Keyword If     '${Status}' == 'FAIL'    Capture Page Screenshot    D:/robot_pjtest/results/TC06_RemoveCowprogress/Screenshot/${tcid}.png
    ...
    END                                                    
    Save Excel Document    D://robot_pjtest//results//TC06_RemoveCowprogress//WriteExcel//TC06_RemoveCowprogress_Result.xlsx
...
#     # #กรณีที่ปฎิเสธ
#      Sleep  20s
#      Wait Until Page Contains Element    ${vb_Cancel}
#      Click Element    ${vb_Cancel}

# DT
#     # #กรณีตกลงที่จะลบ
#     Wait Until Page Contains Element    ${vb_delete}   
...
Check Error page 
    [Arguments]     ${Actual_Result}
        ...
        IF  "${testcaseData}" == "TC001"
                ...
                # Run Keyword If     '${vt_ms} ' == 'FAIL'    Capture Page Screenshot    D:/robot_pjtest/results/TC06_RemoveCowprogress/Screenshot/${testcaseData}.png   
                Click Element    ${vb_delete}
                Sleep  7s
           END 
