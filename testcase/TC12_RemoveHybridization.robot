...
${vb_cprogress}    xpath=//android.view.View[@content-desc="การผสมพันธุ์โค"]

${vb_Swipe}    xpath=//android.widget.ImageView[@index='0'][1]
${vb_Remove}    xpath=//android.widget.Button[@content-desc="ลบข้อมูลการผสมพันธุ์โค"]
...
*** Test Cases ***
TC12_RemoveHybridization
    Start Video Recording    name=D:/robot_pjtest/results/TC12_RemoveHybridization/video/TC12_RemoveHybridization  fps=None    size_percentage=1   embed=True  embed_width=100px   monitor=1    
    Open Excel Document    D:/robot_pjtest/testdata/TC12_RemoveHybridization.xlsx    doc_id=TestData
    ...
    FOR    ${i}    IN RANGE    2    ${excel.max_row+1}
        ...
        LoginPage 
            ...
            Run Keyword If     '${Status}' == 'FAIL'    Capture Page Screenshot    D:/robot_pjtest/results/TC12_RemoveHybridization/Screenshot/${tcid}.png
    ...
    END                                                    
    Save Excel Document    D://robot_pjtest//results//TC12_RemoveHybridization//WriteExcel//TC12_RemoveHybridization_Result.xlsx
