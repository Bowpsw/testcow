...
${vb_cprogress}    xpath=//android.view.View[@content-desc="การฉีดวัคซีน"]

${vb_Swipe}    xpath=//android.widget.ImageView[@index='0'][1]
${vb_Remove}    xpath=//android.widget.Button[@content-desc="ลบข้อมูลการฉีดวัคซีน"]
...
*** Test Cases ***
TC10_RemoveCowVaccine
    Start Video Recording    name=D:/robot_pjtest/results/TC10_RemoveCowVaccine/video/TC10_RemoveCowVaccine  fps=None    size_percentage=1   embed=True  embed_width=100px   monitor=1    
    Open Excel Document    D:/robot_pjtest/testdata/TC10_RemoveCowVaccine.xlsx    doc_id=TestData
    ...
    FOR    ${i}    IN RANGE    2    ${excel.max_row+1}
        ...
        LoginPage 
            ...
            Run Keyword If     '${Status}' == 'FAIL'    Capture Page Screenshot    D:/robot_pjtest/results/TC10_RemoveCowVaccine/Screenshot/${tcid}.png
    ...
    END                                                    
    Save Excel Document    D://robot_pjtest//results//TC10_RemoveCowVaccine//WriteExcel//TC10_RemoveCowVaccine_Result.xlsx
